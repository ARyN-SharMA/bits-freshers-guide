...
export default function DualDegreePage() {
  const getRecommendationStyle = (recommendation: string) => {
    ...
    if (lower.includes("prefer") || lower.includes("good") || lower.includes("decent")) {
    ...
    <div className="min-h-screen px-6 py-8 lg:px-8">
      <div className="mx-auto max-w-6xl space-y-8">
        ...
        <div className="text-center space-y-4 animate-fade-in-up">
          ...
          <h1 className="text-4xl font-bold tracking-tight">Dual Degree Courses</h1>
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
            Complete guide to all 8 compulsory courses for dual degree students with detailed instructor
            recommendations.
          </p>
